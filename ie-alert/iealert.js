...
(function ($) {
    ...
    $.fn.iealert = function (options) {
        var defaults = {
            support:"ie8",
            title:"בלי להעליב, אבל אמרו לך פעם שהדפדפן שלך מיושן?", //"Did you know that your Internet Explorer is out of date?", 
            text:"בכדי לקבל את החוויה המיטבית מאתר זה אנחנו מציעים לך לעדכן לדפדפן מודרני. בכדי להתקין דפדפן חדש יותר יש ללחוץ על כפתור השדרוג.", //To get the best possible experience using our site we recommend that you upgrade to a modern web browser. To download a newer web browser click on the Upgrade button.",
            upgradeTitle:"שדרג",
