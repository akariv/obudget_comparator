...
/usr/local/share/npm/bin/uglifyjs libs/jquery.min.js libs/ie-alert/iealert.js libs/d3.v3.min.js libs/underscore-min.js libs/backbone-min.js libs/native.history.min.js libs/bootstrap.js libs/select2.min.js vis.min.js > budget.min.js
