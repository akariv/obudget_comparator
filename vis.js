...
(function() {
  var BubbleChart, CompareData, addState, charts, explanations, first_time, formatNumber, getExplanation, globalSelectedItem, handleNewState, removeState, state, stories, _ref, _ref1,
  ...
  BubbleChart = (function(_super) {
    ...
    BubbleChart.prototype.render = function() {
      ...
      search.select2({
        placeholder: 'תקציב ' + (this.model.get('breadcrumbs')) + ": חפשו סעיף ספציפי",
        allowClear: true,
        data: this.titles
      });
      search.on("select2-highlight", function(e) {
  ...
  handleNewState = function() {
    ...
    first_time = false;
    return $(".btnCancel:first").css("display", "none");
  };
  ...
  window.handleStories = function(data) {
    ...
    $(".btnCancel:last").live("click", function() {
      removeState();
      return false;
    });
