...
(function() {
  ...
  handleNewState = function() {
    var el, fblike, i, id, max, nextquery, overlaid, query, subtitle, template, title, ___iced_passed_deferral, __iced_deferrals, __iced_k, _i, _j, _ref2, _ref3, _ref4, _ref5,
      _this = this;
    ...
    (function(__iced_k) {
      ...
      var _ref6;
      return (_ref6 = window.FB) != null ? _ref6.XFBML.parse() : void 0;
    });
  };
